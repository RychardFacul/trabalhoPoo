...
<link href="../../css/produtosDesc.css" rel="stylesheet">
    ...
    <div class="row" style="margin-top: 80px">
        ...
        <div class="col-md-7">
            ...
            <div class="mt-3"><a class="btn buttonComprarProdDesc" data-toggle="modal" data-target="#exampleModalCenter" href="{{ route('addAoCarrinho', ['prodId' => $produto['id']]) }}">ADICIONAR AO CARRINHO</a></div>
        </div>
        <div class="col-md-1"></div>
    </div>
